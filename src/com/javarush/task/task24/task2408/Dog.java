    ...
    public Sayable toSayable(final int i) {
        class DogPet extends SuperDog implements Sayable{
            ...
            private String getName(){
                ...
                return sBuilder.append(getSuperQuotes()).append(Dog.this.getName()).append(getSuperQuotes()).toString();
            }
            ...
            public String say() {
                if(i<1){
                    ...
                    sBuilder = new StringBuilder(getName()+" лает г");
                    int x = i;
                    while(x!=0){
                        sBuilder.append("а");
                        x--;
                    }
                    return sBuilder.append("в! ").append(formatter.format((Calendar.getInstance().getTime()))).toString();
                }
            }
        }
       return new DogPet();
